      ...
      <div>
        <nav className="navbar navbar-expand-lg navbar-light" style={{ backgroundColor: '#000000' }}>
          ...
          <div className="collapse navbar-collapse" id="navbarNavAltMarkup" style={{}}>
            <img src={"./Logo.PNG"} className="" alt="..." style={{ width: "80px" }} />
            <div className="navbar-nav" style={{ color: "white", marginLeft: "500px" }}>
        ...
        <div style={{ backgroundColor: "#000000", width: "100%", height: "400px", display: "flex" }}>
          ...
          <div>
            <img src={"./Logo2.PNG"} className="" alt="..." style={{ width: "400px", marginLeft: "50px" }} />
          </div>
        ...
        <div style={{ width: '100%', height: '1200px', backgroundColor: '#000000' }}>
          <h1 style={{ color: 'white', marginLeft: "400px" }}>Services We're Offering</h1>
          <div style={{ display: 'flex', marginLeft: "60px", justifyContent: '', marginTop: "50px" }}>
            <div>
              <div className="card" style={{ width: "400px", height: '270px', backgroundColor: '#4d4242' }}>
            ...
            <div>
              <div className="card" style={{ width: "400px", height: '270px', marginLeft: '130px', backgroundColor: '#4d4242' }}>
                <div className="card-body">
                  <img src={'./logo8.PNG'} alt='' style={{ width: "70px" }} />
                  <h5 className="card-title" style={{ color: "white", marginTop: "50px" }}>Web/Mobile Application</h5>
                  <p className="card-text" style={{ color: "white" }}>Some quick example text to build on the card title and make up the bulk of the card's content. and make up the bulk of the card's content. and make up the bulk of the card's content.</p>
                </div>
              </div>
            </div>
          </div>
